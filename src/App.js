...
const [disNum, newDisNum] = useState('')

const addNum = (num) => {
    newDisNum(disNum => disNum + num)
}

const addOp = (operator) => {
  if (operator === '=' ){
    newDisNum(disNum => eval(disNum))
  }
  else {
    newDisNum(disNum => disNum + ' ' + operator + ' ')
}}
